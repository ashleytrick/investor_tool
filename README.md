...
Kismet collapses that work into a few hours, without trading away the part that matters: a thoughtful, specific note from you to each partner, that you actually read before it goes out.
...
- **Meeting prep when you need it.** When a partner replies or books, Kismet builds a dossier — how they think, firm snapshot, fit framing, likely objections — and pushes it to your Drive as a Google Doc.
- **CRM sync if you want it.** Optional Attio integration keeps approved outreach, replies, and outcomes in your existing pipeline. Skip it and Kismet works the same.

## How it works

1. **Sign up with Google.** One consent step covers Gmail drafts and Drive dossiers.
2. **Upload your pitch deck.** Kismet drafts your company profile — one-liner, stage, traction, ICP, target investor criteria. You review and confirm.
3. **Bring your investor list, or start from scratch.** Drop in an OpenVC export, an Apollo CSV, or a list you've been keeping in a spreadsheet. Kismet enriches partner names, recent deals, fund focus, and contact info.
4. **Review the recommendations.** Kismet ranks partners by fit and surfaces the evidence behind each score — so you know *why* before you decide to reach out.
...
7. **Reply lands? Get a brief.** When a partner replies substantively or books a meeting, Kismet prepares a dossier so you walk in informed.
...
Kismet is built around the opposite stance:

- **Approval-gated by design.** Nothing leaves the system without you reading it. The product refuses to send. We mean this — there is no auto-send flag.
...
- **Honest about scope.** Cold email gets you the meeting. The dossier gets you ready for it. Kismet doesn't pretend a cold email should run 600 words.
...
Kismet is in private beta with founders actively running pre-seed and seed rounds.

→ **Reach out:** [ashley@kismet.fund](mailto:ashley@kismet.fund)
