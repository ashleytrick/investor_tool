"""Markdown rendering for the meeting-prep artifact.

Build Session 16: objection_map + framing_brief were folded into
the investor_dossier (whose schema covers topics_to_handle +
anticipated_questions + pitch_framing in one shape). Only
`render_investor_dossier` remains.
